...
private carStateViewModel viewModel;
private TextView VINDisplay;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(requireActivity()).get(carStateViewModel.class);
    ...
    private void setScreenButtons(View rootView) {
        ...
        VINAccepted.setOnClickListener(click -> {
           ...
           ConnectionManager.getInstance().getBluetoothLink().requestBond();
