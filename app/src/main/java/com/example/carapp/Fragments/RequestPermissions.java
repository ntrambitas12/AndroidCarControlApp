    ...
    private ActivityResultLauncher<String[]> requestPermissionsLauncher =
            registerForActivityResult(new ActivityResultContracts.RequestMultiplePermissions(), isGranted -> {
                ...
                if (allGranted) {
                    ...
                    NavDirections actionLogin = RequestPermissionsDirections.actionRequestPermissions2ToLoginFragment2();
                    Navigation.findNavController(getView()).navigate(actionLogin);
                } else {
